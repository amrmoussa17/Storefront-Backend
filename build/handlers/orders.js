...
exports.getCurrentOrder = exports.addProduct = exports.createOrder = void 0;
...
var getCurrentOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, currentOrder, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                res.json({
                    status: 'ok',
                    data: currentOrder,
                    message: "current order by user: ".concat(userId, " retrieved successfully")
                });
                return [3 /*break*/, 3];
            case 2:
                error_3 = _a.sent();
