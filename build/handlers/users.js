...
exports.authenticate = exports.index = exports.show = exports.create = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, res.status(401).json({ message: 'login error, Enter credentials correctly' })];
                }
